# Generated by GNU Bison xml2gml.xsl 3.7.4.
...
[
 ...
 "14R13" [label="R13", fillcolor=3, shape=diamond, style=filled]
  15 [label="State 15\n\n  1 $@1: %empty\n  2 startdot: utf thetype thename $@1 \"{\" statements \"}\"\l"]
  15 -> 18 [style=dashed label="$@1"]
  15 -> "15R1" [style=solid]
 "15R1" [label="R1", fillcolor=3, shape=diamond, style=filled]
  16 [label="State 16\n\n 14 ctext: ctext \"+\" \"string\"\n 17 text: ctext  [\"{\", \"}\", \",\", \":\", \"=\", \";\", \"[\", \"]\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\", \"-> or --\"]\l"]
 ...
 "26R64" [label="R64", fillcolor=3, shape=diamond, style=filled]
  27 [label="State 27\n\n 31 nidid: text  [\"{\", \"}\", \",\", \";\", \"[\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\"]\n 32      | text \":\" text\n 33      | text \":\" text \":\" text\n 34 nid: text  [\"-> or --\"]\n 35    | text \":\" text\n 36    | text \":\" text \":\" text\n 65 aset: text \"=\" text\n 66     | text \"=\" htext\l"]
 ...
 "38R27" [label="R27", fillcolor=3, shape=diamond, style=filled]
  39 [label="State 39\n\n 67 sstatement: shead \"{\" statements \"}\"\l"]
 ...
 "52R47" [label="R47", fillcolor=3, shape=diamond, style=filled]
  ...
  56 [label="State 56\n\n 32 nidid: text \":\" text  [\"{\", \"}\", \",\", \";\", \"[\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\"]\n 33      | text \":\" text \":\" text\n 35 nid: text \":\" text  [\"-> or --\"]\n 36    | text \":\" text \":\" text\l"]
 ...
 "66R44" [label="R44", fillcolor=3, shape=diamond, style=filled]
  ...
  68 [label="State 68\n\n 28 statement2: sstatement $@2 oattrib\l"]
 ...
 "75R54" [label="R54", fillcolor=3, shape=diamond, style=filled]
  76 [label="State 76\n\n 57 erhs: \"-> or --\" sstatement  [\"{\", \"}\", \",\", \";\", \"[\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\"]\n 58 $@9: %empty  [\"-> or --\"]\n 59 erhs: \"-> or --\" sstatement $@9 erhs\l"]
 ...
 "76R57" [label="R57", fillcolor=3, shape=diamond, style=filled]
  77 [label="State 77\n\n 45 tattr: \"[\" iattr \"]\"\n 46 oattrib: tattr oattrib\n 47        | %empty  [\"{\", \"}\", \",\", \";\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\"]\n 50 estatement: nid $@4 erhs $@5 oattrib\l"]
 ...
 "84R67" [label="R67", fillcolor=3, shape=diamond, style=filled]
  85 [label="State 85\n\n 33 nidid: text \":\" text \":\" text  [\"{\", \"}\", \",\", \";\", \"[\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\"]\n 36 nid: text \":\" text \":\" text  [\"-> or --\"]\l"]
 ...
 "94R53" [label="R53", fillcolor=3, shape=diamond, style=filled]
  95 [label="State 95\n\n 35 nid: text \":\" text  [\"{\", \"}\", \",\", \";\", \"[\", \"graph\", \"subgraph\", \"node\", \"edge\", \"text\", \"number\", \"string\", \"-> or --\"]\n 36    | text \":\" text \":\" text\l"]
